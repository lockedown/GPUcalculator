...
export default function HardwareClient({ initialGpus }: Props) {
  const [vendorFilter, setVendorFilter] = useState<string | null>(null);

  const gpus = vendorFilter
    ? initialGpus.filter((g) => g.vendor === vendorFilter)
    : initialGpus;
          ...
          >
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-1.5">
                ...
                {gpu.is_estimated && (
                  <Badge variant="outline" className="text-orange-500 border-orange-200">EST</Badge>
                )}
              </div>
            </div>
