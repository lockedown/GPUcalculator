...
('H200 SXM', 'NVIDIA', 'Hopper', 'SXM', 141, 'HBM3e', 4.8, 141, 'HBM3e', 4.8, 1970, NULL, NULL, NULL, false, 700, 'air', 'NVLink 4', 900, 'NVLink 4', 'Any', '["inference", "training", "fine-tuning"]', 8, false, NULL, NULL, 30000, false, '2024-Q1', NOW(), NOW()),
...
('RTX PRO 6000 BSE', 'NVIDIA', 'Blackwell', 'PCIe', 96, 'GDDR7', 1.6, 96, 'GDDR7', 1.6, NULL, NULL, NULL, 6600, true, 600, 'air', 'PCIe Gen 5 x16', 32, 'PCIe', 'Air', '["inference"]', 8, false, NULL, NULL, 8500, false, '2025-Q1', NOW(), NOW());
