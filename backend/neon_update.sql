...
('B100 HGX', 'STAC-A2', 'quant', 'Tick analytics, options pricing (Black-Scholes), time-series aggregation on financial datasets', 'Capable', 52, '~28B ops/s', 28, 'B ops/s'),
...
('B100 HGX', 'Monte Carlo FP64', 'quant', 'Path simulation for VaR, CVA, options — double-precision throughput-bound', 'Capable', 48, '90 TFLOPS', 90, 'TFLOPS'),
...
('B100 HGX', 'cuBLAS / rocBLAS DGEMM', 'quant', 'Dense FP64 matrix multiply — covariance, factor calibration, portfolio optimisation, FINMA IMM', 'Capable', 48, '90 TFLOPS', 90, 'TFLOPS'),
...
('B100 HGX', 'QuantLib GPU / XVA', 'risk', 'CVA/DVA/FVA computation, exposure profiles, netting sets — DORA Art.11 risk-critical', 'Capable', 46, '~1.5× H200', 1.5, 'multiplier'),
...
('B100 HGX', 'VaR / Stressed VaR Batch', 'risk', 'Historical simulation VaR, 10,000+ scenarios, FRTB IMA SA — EBA/MiFID II reporting', 'Capable', 46, '~1.5× H200', 1.5, 'multiplier'),
...
('B100 HGX', 'Stress Testing (DFAST/EBA)', 'risk', 'Macro scenario propagation through loan/trading book models — EBA annual cycle', 'Capable', 46, '~1.5× H200', 1.5, 'multiplier'),
...
('B100 HGX', 'MLPerf Inference v4', 'inference', 'Llama2-70B, GPT-J, BERT-Large — server & offline, trade surveillance, comms NLP', 'Capable', 40, '~38k tok/s', 38, 'k tok/s'),
...
('B100 HGX', 'vLLM / TRT-LLM Throughput', 'inference', 'Continuous batching LLM serving — regulatory filing analysis, client comms, AML NLP', 'Capable', 42, '~6.5k/GPU', 6.5, 'k/GPU'),
...
('B100 HGX', 'ONNX RT / ROCm Inference', 'inference', 'Credit scoring, fraud, AML, KYC classification — SR 11-7 model validation environments', 'Strong', 64, '~1.3× H200', 1.3, 'multiplier'),
...
('B100 HGX', 'HPL / LINPACK', 'hpc', 'Dense FP64 FLOPS — actuarial (Solvency II), capital adequacy, FINMA IMM internal model', 'Capable', 48, '90 TFLOPS', 90, 'TFLOPS'),
...
('B100 HGX', 'HPCG (Sparse CG)', 'hpc', 'Sparse linear algebra — credit network graphs, interconnected counterparty exposure modelling', 'Capable', 50, '~1.7× H200', 1.7, 'multiplier'),
...
('B100 HGX', 'STREAM (Memory BW)', 'hpc', 'Sustained HBM bandwidth — large portfolio streaming, factor data loading, time-series scan', 'Capable', 50, '8.0 TB/s', 8, 'TB/s'),
...
('B100 HGX', 'GPU-Direct RDMA / FIO', 'trading', 'Storage-to-GPU bandwidth — tick history replay, EOD P&L recalc, MiFID II 5yr audit pipelines', 'Strong', 56, '~160 GB/s', 1.6e+11, 'B/s'),
...
('B100 HGX', 'Interconnect BW (NVLink / Infinity Fabric)', 'trading', 'Peer-to-peer GPU fabric bandwidth — model parallelism for trading signal ensembles and large risk models', 'Capable', 30, 'NVL5: 1.8 TB/s', 1.8, 'TB/s'),
...
('B100 HGX', 'Prefill Throughput', 'tokenization', 'Prompt ingestion rate — regulatory document analysis, long-form contract NLP, FRTB/DORA policy parsing at scale', 'Capable', 44, '~32K tok/s', 32000, 'tok/s'),
...
('B100 HGX', 'Decode Throughput', 'tokenization', 'Autoregressive generation rate — real-time AML alert narratives, automated DORA incident reports, client advisory drafting, trade surveillance summaries', 'Capable', 46, '~90 tok/s', 90, 'tok/s'),
...
('B100 HGX', 'Batched Decode (BS=128)', 'tokenization', 'High-concurrency generation — parallel AML case processing, multi-analyst regulatory Q&A, concurrent trade commentary across desks', 'Capable', 44, '~7.5K tok/s', 7500, 'tok/s'),
...
('B100 HGX', 'KV Cache Capacity', 'tokenization', 'Concurrent context slots in VRAM — long-document analysis (ISDA agreements, prospectuses), extended regulatory dialogue, multi-turn audit assistant sessions', 'Capable', 36, '~5 slots (192GB)', 5, 'slots (192GB'),
...
('B100 HGX', 'Time-to-First-Token', 'tokenization', 'Prefill latency for 4K prompt — real-time trade surveillance alert triage, intraday risk NLP query response, latency-sensitive compliance workflows', 'Strong', 68, '~140ms', 140, 'ms'),
...
('B100 HGX', 'Max Context Length', 'tokenization', 'Longest document processable in-VRAM without paging — full Basel IV framework analysis, complete MiFID II rulebook Q&A, entire loan agreement review in single pass', 'Strong', 48, '~160K tokens', 160000, 'tokens'),
...
('B100 HGX', 'FP8 Quantised Throughput', 'tokenization', 'Inference throughput at INT8/FP8 precision — maximising token volume for batch regulatory processing, overnight compliance report generation, cost-optimised AML screening', 'Strong', 70, '~1.8× vs FP16', 1.8, 'multiplier'),
